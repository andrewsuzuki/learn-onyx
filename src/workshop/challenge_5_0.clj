...
(defn build-lifecycles []
  [{:lifecycle/task :read-segments
    :lifecycle/calls :workshop.challenge-5-0/reader-lifecycle
   ...
   {:lifecycle/task :write-even-segments
    :lifecycle/calls :workshop.challenge-5-0/writer-lifecycle
    :core.async/id (java.util.UUID/randomUUID)
...
(def flow-conditions
  [{:flow/from :squared
    ...
    :flow/predicate :workshop.challenge-5-0/even-segment?
    :flow/doc "Route to :write-even-segments if :in in this segment is even"}

   {:flow/from :squared
    :flow/to [:write-odd-segments]
    :flow/predicate :workshop.challenge-5-0/odd-segment?
